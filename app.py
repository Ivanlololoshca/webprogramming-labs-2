...
<html>
<head>
    <title>Левенец, Григорович лаба 1</title>
...
<img src="''' + url_for('static', filename='ngta') + '''"  width=500px, height=500px>
...
<body>
   ...
   <h2>Python, согласно данным из Google – язык программирования высокого
    ...
    <img src="''' + url_for('static', filename='python') + '''" width=500px, height=500px>
...
<body>
    ...
    <img src="''' + url_for('static', filename='kuk') + '''"  width=500px, height=500px>
